                      ...
                      dashboardPage(#theme = shinytheme("sandstone") ,
                        ...
                        tabItems(
                            tabItem("bg_graphs",
                                    ...
                                    fluidRow(
                                      ...
                                      p(strong("- Global background subtraction."),"Global background approach involves subtracting a single value for
                                        ...
                                        a given array. "),
                                      p(strong("- Moving mininimum"),"The background intensities are replaced with the minimums of the local backgrounds 
                                        in a given block/mini array. This is utilised mostly if there is a block artefact 
                                        observed in the background intensities."), 
                                      p(strong("- Half Moving mininimum "),"Minimum-half involves a two-step background correction approach and it is 
                                      ...
                                      p(strong("- Normexp background correction") ,"This approach corrects the background using a two mixture model of normal and exponential distribution for 
                            ...
                            tabItem("plot_correct",
                                    fluidRow(
                                      h2(strong("Select the background correction option to view how it performs on your data. The red 
