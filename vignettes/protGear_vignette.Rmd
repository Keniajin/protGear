...
```{r}
visualize_slide(infile='data/array_data/machine1/KK2-06.txt' , MFI_var ='B635 Median' )
```

#### Visualize the background using the `visualize_slide_2d` function

```{r}
visualize_slide_2d(infile='data/array_data/machine1/KK2-06.txt' , MFI_var ='F635 Median' )
```
