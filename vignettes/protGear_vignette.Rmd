...
## Shiny application
Shiny is an R package that makes it easy to build interactive web apps straight from R. protGear includes an interactive dashboard. The dashboard is launched as below form R. To Install R: Open an internet browser and go to www.r-project.org.
